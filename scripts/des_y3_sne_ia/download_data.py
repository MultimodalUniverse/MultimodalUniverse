...
def main(args):
    ...
    url = "https://raw.githubusercontent.com/PantheonPlusSH0ES/DataRelease/main/Pantheon%2B_Data/1_DATA/photometry/DES3YR_DES_COMBINED_TEXT/"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Transfer data DES Y3 to user-provided destination folder."
    )
    parser.add_argument(
        "--destination_path",
        type=str,
