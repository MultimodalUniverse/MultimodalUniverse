...
def main(args):
    # Retrieve file paths
    file_dir = args.ps1_sne_ia_data_path
    ...
    for file in files:
        ...
        metadata_['SNTYPE']="Ia"
        metadata_['object_id']='PS1_'+str(metadata_['SNID'])
    ...
    if not args.dirty:
        shutil.rmtree(args.ps1_sne_ia_data_path)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Extract PS1 SNe Ia data and convert to standard time-series data format.')
    parser.add_argument('ps1_sne_ia_data_path', type=str, help='Path to the local copy of the PS1 SNe Ia data', default='./ps1_sne_ia')
