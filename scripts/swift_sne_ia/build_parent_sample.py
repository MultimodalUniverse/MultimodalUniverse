...
def main(args):
    # Retrieve file paths
    file_dir = args.swift_sne_ia_data_path
    ...
    if not args.dirty:
        shutil.rmtree(args.swift_sne_ia_data_path)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Extract Swifd SNe Ia data and convert to standard time-series data format.')
    parser.add_argument('swift_sne_ia_data_path', type=str, help='Path to the local copy of the Swift SNe Ia data', default='./swift_sne_ia')
