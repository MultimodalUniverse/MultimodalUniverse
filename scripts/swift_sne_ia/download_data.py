...
def main(args):
    ...
    if not os.path.exists(args.destination_path+'/swift_sne_ia/'):
        os.makedirs(args.destination_path+'/swift_sne_ia/')
        
    for file in names:
        download_text_file(url+file,args.destination_path+'/swift_sne_ia/'+file)
