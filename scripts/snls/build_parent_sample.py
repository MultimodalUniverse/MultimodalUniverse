...
def main(args):
    ...
    if not args.dirty:
        shutil.rmtree(args.snls_data_path)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Extract SNLS data and convert to standard time-series data format.')
    parser.add_argument('snls_data_path', type=str, help='Path to the local copy of the SNLS data', default='./snls')
