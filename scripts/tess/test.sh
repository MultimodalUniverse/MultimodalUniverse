...
for dataset in spoc qlp tglc; do
    ...
    if python build_parent_sample.py --pipeline $dataset -s 20,40,62,63 --data_path "./${dataset}-tiny" --hdf5_output_path "./${dataset}-tiny" --fits_output_path "./${dataset}-tiny/fits" --n_processes 6 --tiny; then
