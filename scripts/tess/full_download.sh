...
# Configuration
DATA_PATH="/mnt/ceph/users/polymathic/MultimodalUniverse/spoc"  # Change this to your data directory
PIPELINE="spoc"
N_PROCESSES=64
...
# This sets the logging level for Python's logging module
export PYTHONLOGGING_LEVEL="WARNING"

# First, run a test with sector 1 to make sure everything works
echo "Running test download with sector 1..."
python -W ignore build_parent_sample.py -s 63 $COMMON_ARGS
...
python -W ignore build_parent_sample.py -s all $COMMON_ARGS
