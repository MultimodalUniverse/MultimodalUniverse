...
_EXTRA_FEATURES = dict(
    ...
    AP = dict(
        abp_gspphot = Value(dtype="float32"),
        abp_gspphot_lower = Value(dtype="float32"),
        abp_gspphot_upper = Value(dtype="float32"),
        activityindex_espcs = Value(dtype="float32"),
        activityindex_espcs_input = Value(dtype="int8"),
        activityindex_espcs_uncertainty = Value(dtype="float32"),
        ag_esphs = Value(dtype="float32"),
        ag_esphs_uncertainty = Value(dtype="float32"),
        ag_gspphot = Value(dtype="float32"),
        ag_gspphot_lower = Value(dtype="float32"),
        ag_gspphot_upper = Value(dtype="float32"),
        ag_msc = Value(dtype="float32"),
        ag_msc_lower = Value(dtype="float32"),
        ag_msc_upper = Value(dtype="float32"),
        age_flame = Value(dtype="float32"),
        age_flame_lower = Value(dtype="float32"),
        age_flame_upper = Value(dtype="float32"),
        alphafe_gspspec = Value(dtype="float32"),
        alphafe_gspspec_lower = Value(dtype="float32"),
        alphafe_gspspec_upper = Value(dtype="float32"),
        arp_gspphot = Value(dtype="float32"),
        arp_gspphot_lower = Value(dtype="float32"),
        arp_gspphot_upper = Value(dtype="float32"),
        azero_esphs = Value(dtype="float32"),
        azero_esphs_uncertainty = Value(dtype="float32"),
        azero_gspphot = Value(dtype="float32"),
        azero_gspphot_lower = Value(dtype="float32"),
        azero_gspphot_upper = Value(dtype="float32"),
        azero_msc = Value(dtype="float32"),
        azero_msc_lower = Value(dtype="float32"),
        azero_msc_upper = Value(dtype="float32"),
        bc_flame = Value(dtype="float32"),
        cafe_gspspec = Value(dtype="float32"),
        cafe_gspspec_linescatter = Value(dtype="float32"),
        cafe_gspspec_lower = Value(dtype="float32"),
        cafe_gspspec_nlines = Value(dtype="int32"),
        cafe_gspspec_upper = Value(dtype="float32"),
        cefe_gspspec = Value(dtype="float32"),
        cefe_gspspec_linescatter = Value(dtype="float32"),
        cefe_gspspec_lower = Value(dtype="float32"),
        cefe_gspspec_nlines = Value(dtype="int32"),
        cefe_gspspec_upper = Value(dtype="float32"),
        classlabel_espels = Value(dtype="int8"),
        classlabel_espels_flag = Value(dtype="int8"),
        classprob_dsc_allosmod_galaxy = Value(dtype="float32"),
        classprob_dsc_allosmod_quasar = Value(dtype="float32"),
        classprob_dsc_allosmod_star = Value(dtype="float32"),
        classprob_dsc_combmod_binarystar = Value(dtype="float32"),
        classprob_dsc_combmod_galaxy = Value(dtype="float32"),
        classprob_dsc_combmod_quasar = Value(dtype="float32"),
        classprob_dsc_combmod_star = Value(dtype="float32"),
        classprob_dsc_combmod_whitedwarf = Value(dtype="float32"),
        classprob_dsc_specmod_binarystar = Value(dtype="float32"),
        classprob_dsc_specmod_galaxy = Value(dtype="float32"),
        classprob_dsc_specmod_quasar = Value(dtype="float32"),
        classprob_dsc_specmod_star = Value(dtype="float32"),
        classprob_dsc_specmod_whitedwarf = Value(dtype="float32"),
        classprob_espels_bestar = Value(dtype="float32"),
        classprob_espels_dmestar = Value(dtype="float32"),
        classprob_espels_herbigstar = Value(dtype="float32"),
        classprob_espels_pne = Value(dtype="float32"),
        classprob_espels_ttauristar = Value(dtype="float32"),
        classprob_espels_wcstar = Value(dtype="float32"),
        classprob_espels_wnstar = Value(dtype="float32"),
        cn0_gspspec_centralline = Value(dtype="float32"),
        cn0_gspspec_width = Value(dtype="float32"),
        cn0ew_gspspec = Value(dtype="float32"),
        cn0ew_gspspec_uncertainty = Value(dtype="float32"),
        crfe_gspspec = Value(dtype="float32"),
        crfe_gspspec_linescatter = Value(dtype="float32"),
        crfe_gspspec_lower = Value(dtype="float32"),
        crfe_gspspec_nlines = Value(dtype="int32"),
        crfe_gspspec_upper = Value(dtype="float32"),
        dec = Value(dtype="float64"),
        dib_gspspec_lambda = Value(dtype="float32"),
        dib_gspspec_lambda_uncertainty = Value(dtype="float32"),
        dibew_gspspec = Value(dtype="float32"),
        dibew_gspspec_uncertainty = Value(dtype="float32"),
        dibewnoise_gspspec_uncertainty = Value(dtype="float32"),
        dibp0_gspspec = Value(dtype="float32"),
        dibp2_gspspec = Value(dtype="float32"),
        dibp2_gspspec_uncertainty = Value(dtype="float32"),
        dibqf_gspspec = Value(dtype="int32"),
        distance_gspphot = Value(dtype="float32"),
        distance_gspphot_lower = Value(dtype="float32"),
        distance_gspphot_upper = Value(dtype="float32"),
        distance_msc = Value(dtype="float32"),
        distance_msc_lower = Value(dtype="float32"),
        distance_msc_upper = Value(dtype="float32"),
        ebpminrp_esphs = Value(dtype="float32"),
        ebpminrp_esphs_uncertainty = Value(dtype="float32"),
        ebpminrp_gspphot = Value(dtype="float32"),
        ebpminrp_gspphot_lower = Value(dtype="float32"),
        ebpminrp_gspphot_upper = Value(dtype="float32"),
        evolstage_flame = Value(dtype="int32"),
        ew_espels_halpha = Value(dtype="float32"),
        ew_espels_halpha_flag = Value(dtype="int32"),
        ew_espels_halpha_model = Value(dtype="float32"),
        ew_espels_halpha_uncertainty = Value(dtype="float32"),
        feiim_gspspec = Value(dtype="float32"),
        feiim_gspspec_linescatter = Value(dtype="float32"),
        feiim_gspspec_lower = Value(dtype="float32"),
        feiim_gspspec_nlines = Value(dtype="int32"),
        feiim_gspspec_upper = Value(dtype="float32"),
        fem_gspspec = Value(dtype="float32"),
        fem_gspspec_linescatter = Value(dtype="float32"),
        fem_gspspec_lower = Value(dtype="float32"),
        fem_gspspec_nlines = Value(dtype="int32"),
        fem_gspspec_upper = Value(dtype="float32"),
        ...
        gravredshift_flame_lower = Value(dtype="float32"),
        gravredshift_flame_upper = Value(dtype="float32"),
        libname_gspphot = Value(dtype="int8"),
        logchisq_gspspec = Value(dtype="float32"),
        logg_esphs = Value(dtype="float32"),
        logg_esphs_uncertainty = Value(dtype="float32"),
        logg_gspphot = Value(dtype="float32"),
        logg_gspphot_lower = Value(dtype="float32"),
        logg_gspphot_upper = Value(dtype="float32"),
        logg_gspspec = Value(dtype="float32"),
        logg_gspspec_lower = Value(dtype="float32"),
        logg_gspspec_upper = Value(dtype="float32"),
        logg_msc1 = Value(dtype="float32"),
        logg_msc1_lower = Value(dtype="float32"),
        logg_msc1_upper = Value(dtype="float32"),
        logg_msc2 = Value(dtype="float32"),
        logg_msc2_lower = Value(dtype="float32"),
        logg_msc2_upper = Value(dtype="float32"),
        logposterior_gspphot = Value(dtype="float32"),
        logposterior_msc = Value(dtype="float32"),
        lum_flame = Value(dtype="float32"),
        lum_flame_lower = Value(dtype="float32"),
        lum_flame_upper = Value(dtype="float32"),
        mass_flame = Value(dtype="float32"),
        mass_flame_lower = Value(dtype="float32"),
        mass_flame_upper = Value(dtype="float32"),
        mcmcaccept_gspphot = Value(dtype="float32"),
        mcmcaccept_msc = Value(dtype="float32"),
        mcmcdrift_msc = Value(dtype="float32"),
        mg_gspphot = Value(dtype="float32"),
        mg_gspphot_lower = Value(dtype="float32"),
        mg_gspphot_upper = Value(dtype="float32"),
        mgfe_gspspec = Value(dtype="float32"),
        mgfe_gspspec_linescatter = Value(dtype="float32"),
        mgfe_gspspec_lower = Value(dtype="float32"),
        mgfe_gspspec_nlines = Value(dtype="int32"),
        mgfe_gspspec_upper = Value(dtype="float32"),
        mh_gspphot = Value(dtype="float32"),
        mh_gspphot_lower = Value(dtype="float32"),
        mh_gspphot_upper = Value(dtype="float32"),
        mh_gspspec = Value(dtype="float32"),
        mh_gspspec_lower = Value(dtype="float32"),
        mh_gspspec_upper = Value(dtype="float32"),
        mh_msc = Value(dtype="float32"),
        mh_msc_lower = Value(dtype="float32"),
        mh_msc_upper = Value(dtype="float32"),
        ndfe_gspspec = Value(dtype="float32"),
        ndfe_gspspec_linescatter = Value(dtype="float32"),
        ndfe_gspspec_lower = Value(dtype="float32"),
        ndfe_gspspec_nlines = Value(dtype="int32"),
        ndfe_gspspec_upper = Value(dtype="float32"),
        neuron_oa_dist = Value(dtype="float32"),
        neuron_oa_dist_percentile_rank = Value(dtype="int32"),
        neuron_oa_id = Value(dtype="int64"),
        nfe_gspspec = Value(dtype="float32"),
        nfe_gspspec_linescatter = Value(dtype="float32"),
        nfe_gspspec_lower = Value(dtype="float32"),
        nfe_gspspec_nlines = Value(dtype="int32"),
        nfe_gspspec_upper = Value(dtype="float32"),
        nife_gspspec = Value(dtype="float32"),
        nife_gspspec_linescatter = Value(dtype="float32"),
        nife_gspspec_lower = Value(dtype="float32"),
        nife_gspspec_nlines = Value(dtype="int32"),
        nife_gspspec_upper = Value(dtype="float32"),
        ra = Value(dtype="float64"),
        radius_flame = Value(dtype="float32"),
        radius_flame_lower = Value(dtype="float32"),
        radius_flame_upper = Value(dtype="float32"),
        radius_gspphot = Value(dtype="float32"),
        radius_gspphot_lower = Value(dtype="float32"),
        radius_gspphot_upper = Value(dtype="float32"),
        sfe_gspspec = Value(dtype="float32"),
        sfe_gspspec_linescatter = Value(dtype="float32"),
        sfe_gspspec_lower = Value(dtype="float32"),
        sfe_gspspec_nlines = Value(dtype="int32"),
        sfe_gspspec_upper = Value(dtype="float32"),
        sife_gspspec = Value(dtype="float32"),
        sife_gspspec_linescatter = Value(dtype="float32"),
        sife_gspspec_lower = Value(dtype="float32"),
        sife_gspspec_nlines = Value(dtype="int32"),
        sife_gspspec_upper = Value(dtype="float32"),
        solution_id = Value(dtype="int64"),
        source_id = Value(dtype="int64"),
        spectraltype_esphs = Value(dtype="int8"),
        teff_esphs = Value(dtype="float32"),
        teff_esphs_uncertainty = Value(dtype="float32"),
        teff_espucd = Value(dtype="float32"),
        teff_espucd_uncertainty = Value(dtype="float32"),
        teff_gspphot = Value(dtype="float32"),
        teff_gspphot_lower = Value(dtype="float32"),
        teff_gspphot_upper = Value(dtype="float32"),
        teff_gspspec = Value(dtype="float32"),
        teff_gspspec_lower = Value(dtype="float32"),
        teff_gspspec_upper = Value(dtype="float32"),
        teff_msc1 = Value(dtype="float32"),
        teff_msc1_lower = Value(dtype="float32"),
        teff_msc1_upper = Value(dtype="float32"),
        teff_msc2 = Value(dtype="float32"),
        teff_msc2_lower = Value(dtype="float32"),
        teff_msc2_upper = Value(dtype="float32"),
        tife_gspspec = Value(dtype="float32"),
        tife_gspspec_linescatter = Value(dtype="float32"),
        tife_gspspec_lower = Value(dtype="float32"),
        tife_gspspec_nlines = Value(dtype="int32"),
        tife_gspspec_upper = Value(dtype="float32"),
        vsini_esphs = Value(dtype="float32"),
        vsini_esphs_uncertainty = Value(dtype="float32"),
        zrfe_gspspec = Value(dtype="float32"),
        zrfe_gspspec_linescatter = Value(dtype="float32"),
        zrfe_gspspec_lower = Value(dtype="float32"),
        zrfe_gspspec_nlines = Value(dtype="int32"),
        zrfe_gspspec_upper = Value(dtype="float32"),
    )
)
...
class Gaia(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        CustomBuilderConfig(
            ...
            version=VERSION,
            data_files=DataFilesPatternsDict.from_patterns(
                {"train": ["./dr3_ap/healpix=*/*.hdf5"]}
            ),
            description="Gaia DR3 astrophysical parameters.",
            extra_features=_EXTRA_FEATURES["AP"],
        ),
    ]
