...
def main(args):
    # Retrieve file paths
    file_dir = args.foundation_data_path
    ...
    for file in files:
        ...
        metadata_['SNTYPE']="Ia"
        metadata_['object_id']=metadata_['SNID']
    ...
    if not args.dirty:
        shutil.rmtree(args.foundation_data_path)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Extract Foundation DR1 data and convert to standard time-series data format.')
    parser.add_argument('foundation_data_path', type=str, help='Path to the local copy of the Foundation DR1 data', default='./foundation_dr1')
