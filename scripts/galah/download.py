...
print("DOWNLOADING MISSING SPECTRA LIST")

os.system(f'aria2c -j16 -s16 -x16 -c  "https://cloud.datacentral.org.au/teamdata/GALAH/public/GALAH_DR3/spectra/GALAH_DR3_list_missing_reduced_spectra_v2.csv" --dir={args.output_dir}')
